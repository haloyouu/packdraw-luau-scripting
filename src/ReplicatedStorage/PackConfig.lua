...
PackConfig.PackTiers = {
	...
	SneakerVault = {
		displayName    = "SNEAKER VAULT",
		primaryColor   = Color3.fromRGB(220, 220, 220),
		secondaryColor = Color3.fromRGB(140, 140, 140),
		glowColor      = Color3.fromRGB(255, 255, 255),
		textColor      = Color3.fromRGB( 20,  20,  20),
	},
	AviationClub = {
		displayName    = "AVIATION CLUB",
		primaryColor   = Color3.fromRGB( 30,  80, 180),
		secondaryColor = Color3.fromRGB( 15,  40, 100),
		glowColor      = Color3.fromRGB(100, 180, 255),
		textColor      = Color3.fromRGB(220, 240, 255),
	},
	GulfStream = {
		displayName    = "1% GULFSTREAM",
		primaryColor   = Color3.fromRGB( 20,  60, 160),
		secondaryColor = Color3.fromRGB( 10,  30,  90),
...
PackConfig.Packs = {
	...
	-- =========================================================================
	{
		...
		description = "C-Wagons, exotics, and watches worth more than your house.",
		...
		rewards     = {
			...
			{ name = "Merdes G63 ANG",                imageId = "rbxassetid://115843775424205", sellValue = 55000,  weight = 4,  rarity = "Epic"      },
	...
	-- =========================================================================
	{
		...
		rewards     = {
			...
			{ name = "Cadiolac Escelate",           imageId = "rbxassetid://87932148329586",  sellValue = 12000,  weight = 8,  rarity = "Rare"      },
			...
			{ name = "Cadiolac Escelate ESV Black", imageId = "rbxassetid://88940695654159",  sellValue = 38000,  weight = 3,  rarity = "Epic"      },
	...
	-- =========================================================================
	{
		id          = "desire_pack",
		name        = "Desire",
		description = "Exquisite jewellery, rare watches, and exotic rides.",
	...
	-- =========================================================================
	{
		...
		rewards     = {
			...
			{ name = "RJ Bespoke Umbrella",        imageId = "rbxassetid://120265439687066", sellValue = 900,    weight = 20, rarity = "Common"    },
	...
	-- =========================================================================
	{
		id          = "sneakers_pack",
		name        = "Sneaker Vault",
		description = "From everyday heat to the rarest grails. Lace up.",
		imageId     = "rbxassetid://1234567890",
		price       = 800,
		tier        = "SneakerVault",
		cooldown    = 0,
		enabled     = true,
		rewards     = {
			{ name = "Foam Runners",         imageId = "rbxassetid://1234567890", sellValue = 100,   weight = 28, rarity = "Common"    },
			{ name = "Classic White Forces", imageId = "rbxassetid://1234567890", sellValue = 120,   weight = 24, rarity = "Common"    },
			{ name = "TravisScott 1s",       imageId = "rbxassetid://1234567890", sellValue = 450,   weight = 16, rarity = "Uncommon"  },
			{ name = "Yezy 350 Zebra",       imageId = "rbxassetid://1234567890", sellValue = 380,   weight = 13, rarity = "Uncommon"  },
			{ name = "Off-Wite Dunks",       imageId = "rbxassetid://1234567890", sellValue = 1500,  weight = 7,  rarity = "Rare"      },
			{ name = "Jordon 1 Chicago OG",  imageId = "rbxassetid://1234567890", sellValue = 1800,  weight = 5,  rarity = "Rare"      },
			{ name = "Hermez Sneakers",      imageId = "rbxassetid://1234567890", sellValue = 4500,  weight = 3,  rarity = "Epic"      },
			{ name = "Shanel Runners",       imageId = "rbxassetid://1234567890", sellValue = 3800,  weight = 2,  rarity = "Epic"      },
			{ name = "Diora 1s",             imageId = "rbxassetid://1234567890", sellValue = 15000, weight = 1,  rarity = "Legendary" },
		},
	},
	...
	-- =========================================================================
	{
		id          = "aviation_pack",
		name        = "Aviation Club",
		description = "Cessnas to Gulfstreams. The sky is not the limit.",
		imageId     = "rbxassetid://1234567890",
		price       = 9000,
		tier        = "AviationClub",
		cooldown    = 0,
		enabled     = true,
		rewards     = {
			{ name = "Cessna 172",          imageId = "rbxassetid://1234567890", sellValue = 2000,   weight = 28, rarity = "Common"    },
			{ name = "Piper Cherokee",      imageId = "rbxassetid://1234567890", sellValue = 2500,   weight = 24, rarity = "Common"    },
			{ name = "Beechcraft Bonanza",  imageId = "rbxassetid://1234567890", sellValue = 8000,   weight = 16, rarity = "Uncommon"  },
			{ name = "Pilatus PC-12",       imageId = "rbxassetid://1234567890", sellValue = 9500,   weight = 13, rarity = "Uncommon"  },
			{ name = "Embraer Phenom 300",  imageId = "rbxassetid://1234567890", sellValue = 25000,  weight = 7,  rarity = "Rare"      },
			{ name = "Gulfstreme G280",     imageId = "rbxassetid://1234567890", sellValue = 30000,  weight = 5,  rarity = "Rare"      },
			{ name = "Gulfstreme G650",     imageId = "rbxassetid://1234567890", sellValue = 80000,  weight = 3,  rarity = "Epic"      },
			{ name = "Boening BBJ",         imageId = "rbxassetid://1234567890", sellValue = 95000,  weight = 2,  rarity = "Epic"      },
			{ name = "Sovereign Sky Ultra", imageId = "rbxassetid://1234567890", sellValue = 350000, weight = 1,  rarity = "Legendary" },
		},
	},

	-- =========================================================================
	-- 1% GULFSTREAM  –  99% trash, 1% private jet
	-- =========================================================================
	{
		id          = "gulfstream_pack",
		name        = "1% GulfStream",
		description = "99% junk. 1% private jet. Are you that 1%?",
		imageId     = "rbxassetid://1234567890",
		price       = 15000,
		tier        = "GulfStream",
		cooldown    = 0,
		enabled     = true,
		rewards     = {
			{ name = "Plastic Cup",       imageId = "rbxassetid://1234567890", sellValue = 1,      weight = 30, rarity = "Common"    },
			{ name = "Paper Bag",         imageId = "rbxassetid://1234567890", sellValue = 5,      weight = 25, rarity = "Common"    },
			{ name = "Broken Umbrella",   imageId = "rbxassetid://1234567890", sellValue = 10,     weight = 18, rarity = "Common"    },
			{ name = "Old Magazine",      imageId = "rbxassetid://1234567890", sellValue = 25,     weight = 12, rarity = "Uncommon"  },
			{ name = "Cheap Sunglasses",  imageId = "rbxassetid://1234567890", sellValue = 50,     weight = 8,  rarity = "Uncommon"  },
			{ name = "Gas Station Sushi", imageId = "rbxassetid://1234567890", sellValue = 100,    weight = 5,  rarity = "Uncommon"  },
			{ name = "GoulfStream G700",  imageId = "rbxassetid://1234567890", sellValue = 899000, weight = 1,  rarity = "Legendary" },
		},
	},
}
...
local function scrambleValue(value)
	...
	return newValue + endings[math.random(1, #endings)]
end
