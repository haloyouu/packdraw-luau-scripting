...
PackConfig.Packs = {
    ...
    -- =========================================================================
    {
        ...
        rewards     = {
            ...
            { name = "Rolez Submariner",  imageId = "rbxassetid://107237501834105",    sellValue = 3000,  weight = 16, rarity = "Epic"      },
            { name = "Audemares Pigeont", imageId = "rbxassetid://133046684762808",    sellValue = 8000,  weight = 8,  rarity = "Epic"      },
